...
func HasOrders() predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
...
func HasOrdersWith(preds ...predicate.Orders) predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasInstruments() predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(InstrumentsTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, InstrumentsTable, InstrumentsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	},
	)
...
func HasInstrumentsWith(preds ...predicate.Instrument) predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
